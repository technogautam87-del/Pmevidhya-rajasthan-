    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-10 text-left">
          ...
          <div className="flex items-center gap-2 text-xs shrink-0 bg-slate-100 px-3 py-1.5 rounded-xl border border-slate-200">
                ...
                {playerMode === "youtube" && selectedChannel.youtubeVideoId ? (
                  ...
                  <>
                    ...
                    {simulatedSubtitlesActive && (
                      <div className="z-10 bg-black/75 rounded p-2 text-left text-[10px] sm:text-xs text-yellow-300 font-bold max-w-sm sm:max-w-md border border-slate-800">
